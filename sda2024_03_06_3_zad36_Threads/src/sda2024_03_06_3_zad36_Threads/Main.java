...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * ZADANIE 36.
Utwórz klasę ThreadPlaygroundRunnable implementującą interfejs Runnable 
posiadająca pole name typu String z konstruktorem publicznym dla tego pola.
...
Na każdym z wątków (Thread) użyj metody start().
		 */
		ThreadPlaygroundRunnable r = new ThreadPlaygroundRunnable("runnable");
